...
const HeroSection = () => {
  return (
    <section
      className="h-screen max-h-[1000px] flex flex-col bg-[url('/background.svg')] bg-cover  bg-local bg-right relative pt-20"
      id="heroSection"
    >
      <Navbar />

      <div className="flex flex-col md:flex-row items-center justify-center w-full max-w-6xl md:mx-auto px-2 md:px-4 lg:px-2 my-auto">
